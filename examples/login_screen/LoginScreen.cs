...
namespace TGUI.Example
{
    class Example
    {
        ...
        static void CreateWidgets(TGUI.Gui gui)
        {
            ...
            editBoxUsername.Position = new (width / 6, height / 6);
            editBoxUsername.Size = new (width * 2/3, height / 8);
            editBoxUsername.DefaultText = "Username";
            gui.Add(editBoxUsername, "EditUsername");

            editBoxPassword = new TGUI.EditBox(editBoxUsername);
            editBoxPassword.Position = new (width / 6, height * 5/12);
            ...
            button.Text = "Login";
            button.Position = new (width / 4, height * 7/10);
            button.Size = new (width / 2, height / 6);
        ...
        {
            var window = new RenderWindow(new VideoMode(new (width, height)), "TGUI.Net example");
